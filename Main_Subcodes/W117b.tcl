   proc US117b {} {
    ...
    set Rc1 [expr $omega15 * $phi1 - $beta15]
    set Rc2 [expr $omega16 * $phi2 - $beta16]
    set Rc3 [expr $omega17 * $phi3 - $beta17] 

    set RC  [expr 0.3333 * ($Rc1 +  $Rc2 + $Rc3)] 
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    foreach rc_bound $Bound117b subrc $RCsub {T1 T2 T3 T4} $tiA117b {
    ...
    foreach CV $CV117b {
     ...
     foreach bnd $aid_Ang117   {
        ...
        if {abs($DelBond) <= $Y} {
            ...
            foreach omegaweight $OmegaWeight117b subrc $RCsub FM $Forces {T1 T2 T3 T4} $tiA117b {
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
        ...
        if {$lable=="FF"} {
            ...
            foreach omegaweight $OmegaWeight117b subrc $RCsub {T1 T2 T3 T4} $tiA117b {
...
proc Exchange117b {oldTag} {
    ...
    global IndF refID angleFixer Eng lable RC angleFixer2 Tag tiA358 tiA366 tiA359 Alpha116a HBond116a Alpha116b HBond116b Alpha117b HBond117b Alpha117b HBond117b Alpha359 HBond359 Bond359 Ang359  Alpha366 HBond366 Bond366 Alpha358 HBond358 Alpha355 HBond355 aid_Ang366 aid_Ang359 aid_Ang358 CV366 CV359 CV358 CV355 CV117b CV117b CV116a CV116b ColVar RCsub Exchange116a Exchange117b OmegaWeight117b omega13 omega14 beta13 beta14 omega15 omega16 omega17 beta15 beta16 beta17
